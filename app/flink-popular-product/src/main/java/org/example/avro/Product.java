...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1188876306973536443L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"count\",\"type\":\"long\"}]}");
   ...
   */
  public Product(java.lang.CharSequence id, java.lang.Long count) {
    this.id = id;
    this.count = count;
  }
   ...
   */
  public static org.example.avro.Product.Builder newBuilder() {
    return new org.example.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.example.avro.Product.Builder newBuilder(org.example.avro.Product.Builder other) {
    if (other == null) {
      return new org.example.avro.Product.Builder();
    } else {
      return new org.example.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.example.avro.Product.Builder newBuilder(org.example.avro.Product other) {
    if (other == null) {
      return new org.example.avro.Product.Builder();
    } else {
      return new org.example.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Product.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Product.Builder setCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Product.Builder clearCount() {
